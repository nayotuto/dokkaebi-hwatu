...
신동호(이하 "개발자")는 모바일 게임 **도깨비화투** 이용자의 개인정보를 소중히 여기며, 「개인정보 보호법」 및 관련 법령을 준수합니다. 본 처리방침은 도깨비화투(이하 "앱")가 수집하는 정보와 그 이용 방법을 안내합니다.

---

### 2. 수집하는 정보

개발자는 이용자로부터 이름, 이메일 등 직접적인 개인정보를 수집하지 않습니다. 다만, 앱 이용 과정에서 다음 정보가 자동으로 수집될 수 있습니다.

- **광고 식별자 (GAID)**: Google AdMob 광고 서비스 제공을 위해 자동 수집
...
개발자는 다음의 경우에 한해 수집된 정보를 제3자에게 제공합니다.
...
본 앱은 만 13세 미만 아동을 대상으로 하지 않습니다. 개발자는 만 13세 미만 아동으로부터 고의로 개인정보를 수집하지 않습니다.

---

### 8. 처리방침 변경 안내

본 처리방침은 법령 변경 또는 서비스 변경에 따라 수정될 수 있습니다. 변경 사항은 본 페이지를 통해 공지하며, 중요한 변경의 경우 앱 업데이트 시 별도 안내합니다.

---

### 9. 문의

개인정보 처리와 관련한 문의는 아래 이메일로 연락 주시기 바랍니다.

- 개발자: 신동호
- 이메일: it.devshin@gmail.com
...
Shin Dongho ("Developer") values the privacy of users of the mobile game **Dokkaebi Hwatu** and complies with applicable privacy laws. This Privacy Policy explains what information the app ("App") collects and how it is used.

---

### 2. Information We Collect

The Developer does not directly collect personal information such as your name or email address. However, the following information may be collected automatically during use of the App.

- **Advertising Identifier (GAID)**: Automatically collected by Google AdMob for advertising purposes
...
The Developer shares collected information with third parties only in the following cases.
...
To the extent applicable, users in the EEA may have additional rights under the General Data Protection Regulation (GDPR), including the right to access, correct, or delete their data. Please contact us for any such requests.

---

### 7. Children's Privacy

This App is not directed at children under the age of 13. The Developer does not knowingly collect personal information from children under 13. If you believe a child under 13 has provided personal information, please contact us and we will take steps to delete it.

---

### 8. Changes to This Policy

This Privacy Policy may be updated to reflect changes in law or the App. Any changes will be posted on this page. For significant changes, additional notice will be provided through an app update.
...
- Developer: Shin Dongho
- Email: it.devshin@gmail.com
